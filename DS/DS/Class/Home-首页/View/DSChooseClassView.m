...
-(void)setGoodsDetail:(DSGoodsDetail *)goodsDetail
{
    ...
    if (_goodsDetail.selectSku) {
        [self.price setFontAttributedText:[NSString stringWithFormat:@"¥%@",[_goodsDetail.discount_price reviseString]] andChangeStr:@[@"¥"] andFont:@[[UIFont systemFontOfSize:12]]];
        [self.market_price setLabelUnderline:[NSString stringWithFormat:@"原价：¥%@",[_goodsDetail.selectSku.price reviseString]]];

        self.stock_num.text = [NSString stringWithFormat:@"库存：%@",_goodsDetail.selectSku.stock];
    }else{
        [self.price setFontAttributedText:[NSString stringWithFormat:@"¥%@",[_goodsDetail.discount_price reviseString]] andChangeStr:@[@"¥"] andFont:@[[UIFont systemFontOfSize:12]]];
        [self.market_price setLabelUnderline:[NSString stringWithFormat:@"原价：¥%@",[_goodsDetail.price reviseString]]];
...
-(void)checkGoodsSpecs
{
    ...
    if (_goodsDetail.selectSku) {
        [self.price setFontAttributedText:[NSString stringWithFormat:@"¥%@",[_goodsDetail.selectSku.discount_price reviseString]] andChangeStr:@[@"¥"] andFont:@[[UIFont systemFontOfSize:12]]];
        [self.market_price setLabelUnderline:[NSString stringWithFormat:@"原价：¥%@",[_goodsDetail.selectSku.price reviseString]]];
