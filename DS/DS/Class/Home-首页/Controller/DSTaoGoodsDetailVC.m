...
-(void)handleGoodsDetailData
{
    ...
    [self.cmm_price setFontAttributedText:[NSString stringWithFormat:@"  预估补贴¥%@  ",[self.goodsDetail.cmm_price reviseString]] andChangeStr:@[@"¥"] andFont:@[[UIFont systemFontOfSize:10]]];
    [self.marketPrice setFontAttributedText:[NSString stringWithFormat:@"现价¥%@",[self.goodsDetail.price reviseString]] andChangeStr:@[[NSString stringWithFormat:@"%@",[self.goodsDetail.price reviseString]]] andFont:@[[UIFont fontWithName:@"ArialMT" size: 12]]];
    ...
    if ([self.goodsDetail.coupon_amount floatValue] == 0) {
        ...
        [self.coupon_amount setFontAttributedText:[NSString stringWithFormat:@"¥%@",[self.goodsDetail.coupon_amount reviseString]] andChangeStr:@[@"¥"] andFont:@[[UIFont systemFontOfSize:14]]];
