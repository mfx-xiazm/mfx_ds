//
//  DSWebChatPayH5View.m
//  DS
//
//  Created by 夏增明 on 2020/1/6.
//  Copyright © 2020 夏增明. All rights reserved.
//

#import "DSWebChatPayH5View.h"

@interface DSWebChatPayH5View ()<UIWebViewDelegate>
...
@implementation DSWebChatPayH5View
    ...
    if (hasReferer) {
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                NSMutableURLRequest* request = [NSMutableURLRequest requestWithURL:url cachePolicy:NSURLRequestUseProtocolCachePolicy timeoutInterval:60.0];
                //设置授权域名
                [request setValue:@"jf.jf180.vip://" forHTTPHeaderField: @"Referer"];
                [self.myWebView loadRequest:request];
            });
        });
        return NO;
