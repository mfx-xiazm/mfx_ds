...
-(void)setOrderGoods:(DSTaoKeOrder *)orderGoods
{
    ...
    [self.pay_amount setFontAttributedText:[NSString stringWithFormat:@"¥%@",[_orderGoods.pay_amount reviseString]] andChangeStr:@[@"¥"] andFont:@[[UIFont systemFontOfSize:10]]];
    ...
    [self.order_self_commission setFontAttributedText:[NSString stringWithFormat:@"¥%@",[_orderGoods.order_self_commission reviseString]] andChangeStr:@[@"¥"] andFont:@[[UIFont systemFontOfSize:12]]];
