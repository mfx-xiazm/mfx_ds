...
-(void)setCart:(DSCartData *)cart
{
    ...
    [self.market_price setLabelUnderline:[NSString stringWithFormat:@"¥%@",[_cart.price reviseString]]];
    [self.price setFontAttributedText:[NSString stringWithFormat:@"¥%@",[_cart.discount_price reviseString]] andChangeStr:@[@"¥"] andFont:@[[UIFont systemFontOfSize:12]]];

    [self.back_price setFontAttributedText:[NSString stringWithFormat:@"现金补贴：¥%@",[_cart.cmm_price reviseString]] andChangeStr:@[@"¥"] andFont:@[[UIFont systemFontOfSize:10]]];
