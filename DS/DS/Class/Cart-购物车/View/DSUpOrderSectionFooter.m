...
{
    _goods = goods;
    [self.price setFontAttributedText:[NSString stringWithFormat:@"¥%@",[[NSString stringWithFormat:@"%f",_goods.totalPrice] reviseString]] andChangeStr:@[@"¥"] andFont:@[[UIFont systemFontOfSize:12]]];
}
