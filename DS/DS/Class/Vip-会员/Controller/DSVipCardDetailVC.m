...
-(void)handleCardDetaiData
{
    ...
    self.member_price.text = [NSString stringWithFormat:@"¥%@",[price.member_price reviseString]];
    self.original_price.text = [NSString stringWithFormat:@"原价¥%@",[price.original_price reviseString]];
