...
- (instancetype)initWithCropImage:(UIImage*)cropImage cropSize:(CGSize)cropSize {
	if (self = [super init]) {
        ...
        bottomLabel.text = (cropSize.width/cropSize.height !=1)?@"请将身份证边缘贴合裁剪框边缘进行裁剪":@"";
        ...
        button.frame = kIsiPhoneX?CGRectMake(0, kScreenHeight - 34.0 - 40.0, 60, 40):CGRectMake(0, kScreenHeight - 60, 60, 40);//button的frame
		button.center = CGPointMake(self.view.center.x,self.view.center.y);
        button.frame = kIsiPhoneX?CGRectMake(button.frame.origin.x, kScreenHeight - 34.0 - 40.0, 60, 40):CGRectMake(button.frame.origin.x, kScreenHeight - 60, 60, 40);//button的frame
        ...
        cancel.frame = kIsiPhoneX?CGRectMake(0, kScreenHeight - 34.0 - 40.0, 60, 40):CGRectMake(0, kScreenHeight - 60, 60, 40);//button的frame
        ...
        confirm.frame = kIsiPhoneX?CGRectMake(kScreenWidth - 60, kScreenHeight - 34.0 - 40.0, 60, 40):CGRectMake(kScreenWidth - 60, kScreenHeight - 60, 60, 40);//button的frame
