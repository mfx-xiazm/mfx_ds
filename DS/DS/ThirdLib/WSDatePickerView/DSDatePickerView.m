...
@interface DSDatePickerView ()<UIPickerViewDelegate,UIPickerViewDataSource,UIGestureRecognizerDelegate> {
    //日期存储数组
...
@implementation DSDatePickerView
/**
 默认滚动到当前时间
 */
...
-(void)addLabelWithName:(NSArray *)nameArr {
    ...
    for (int i=0; i<nameArr.count; i++) {
        ...
        UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake((i==0)?labelX+10:labelX, self.showYearView.frame.size.height/2-15/2.0, 15, 15)];
